...
%     cuvinteVizuale - matrice k x 128, fiecare linie reprezinta un cuvant vizual (un centru al unui cluster)
  ...
  for i=1:numarImagini,
    ...
    % punct de pe caroiaj
    [descriptor, patch] = calculeazaHistogrameGradientiOrientati(img,puncteCaroiaj,dimensiuneCelula);
        
    % pune in descriptoriHOG si patchuri ce ai calculat
    descriptoriHOG((i-1)*nrPuncteX*nrPuncteY + 1:i*nrPuncteX*nrPuncteY,:) = descriptor;
    patchuri((i-1)*nrPuncteX*nrPuncteY + 1:i*nrPuncteX*nrPuncteY,:) = patch;
