...
mu = zeros(1,size(histogrameBOVW_exemple,2));
sigma = zeros(1,size(histogrameBOVW_exemple,2));

for i=1:size(histogrameBOVW_exemple,2)
    mu(1,i) =  mean(histogrameBOVW_exemple(:,i));
    sigma(1,i) =  std(histogrameBOVW_exemple(:,i));
end
